...
export function RegisterPage() {
  ...
  const handleRegister = async (e: FormEvent) => {
    ...
    try {
      ...
      setEmail(form.email)
      setMessage(typeof data === 'string' ? data : (data as { message?: string })?.message ?? 'Check your email for the verification code.')
      setStep('otp')
    } catch {
      ...
      <div className="auth-card">
        ...
        {step === 'otp' && (
          <form className="auth-form" onSubmit={handleVerifyOtp}>
            ...
            <div className="muted">Enter the code we sent to {email}.</div>
            <label>
